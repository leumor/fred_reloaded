...
/**
 * Exception thrown to indicate that a method has been passed an unsupported enum value from one of
 * the various Type enums in the {@link hyphanet.crypt} package.
 *
 * <p>This exception is typically thrown when a cryptographic operation is attempted with an enum
