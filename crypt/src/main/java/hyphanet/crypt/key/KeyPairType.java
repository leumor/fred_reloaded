...
/**
 * An enumeration of supported key pair types for cryptographic operations in Hyphanet. This
 * enum maintains the specifications for various elliptic curve algorithms and legacy DSA
 * support.
 * <p>
 * Each key pair type defines:
 * <ul>
 *   <li>The cryptographic algorithm to use</li>
 *   <li>The curve specification for EC-based algorithms</li>
 *   <li>The expected size of DER-encoded public keys</li>
 * </ul>
 *
 * @author unixninja92
 */
public enum KeyPairType {
    /**
     * Legacy DSA key pair type.
     *
     * @deprecated DSA should only be used for legacy support of old network content. Use
     * {@link #ECP256} for new implementations.
     */
    @Deprecated DSA(),
    ...
    /**
     * The elliptic curve parameter specification. This is null for DSA type.
     */
    public final ECGenParameterSpec spec;

    /**
     * Constructs the DSA enum value with default parameters. This constructor is used only for
     * the legacy DSA type.
     */
    KeyPairType() {
        alg = name();
