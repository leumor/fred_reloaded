...
/**
 * An enumeration of cryptographic key types supported by Hyphanet, defining their properties and
 * characteristics.
 *
 * <p>This enum maintains the specifications for various cryptographic algorithms, including:
 *
 * <ul>
 *   <li>Algorithm names for key generation
 *   <li>Key sizes in bits
 *   <li>Initialization vector (IV) sizes in bits
 * </ul>
 *
 * @author unixninja92
 */
public enum KeyType {
  ...
  /**
   * Constructs a KeyType with the specified algorithm name and key size. The IV size is set equal
   * to the key size.
   *
