...
public final class Global {
    ...
    */
    ...
    /**
     * Retrieves the DSA parameters for the BigA group in BouncyCastle compatible format.
     *
     * <p>This method converts the internal DSAGroup representation to BouncyCastle's
     * DSAParameters format for compatibility with BouncyCastle's cryptographic
     * operations.</p>
     *
     * @return DSAParameters object containing p, q, and g values for the BigA group
     */
    public static DSAParameters getDSAgroupBigAParameters() {
        return new DSAParameters(DSAgroupBigA.getP(), DSAgroupBigA.getQ(),
                                 DSAgroupBigA.getG());
    }
}
