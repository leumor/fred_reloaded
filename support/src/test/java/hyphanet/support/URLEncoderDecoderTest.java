...
/**
 * Test case for {@link hyphanet.support.URLEncoder} and {@link hyphanet.support.URLDecoder} classes.
 *
...
public class URLEncoderDecoderTest {
    ...
    public void testEncodeDecodeString_notSafeBaseChars() {
        String[] toEncode = {
            //safe chars
            URLEncoder.SAFE_URL_CHARACTERS, prtblAscii,
    ...
    /**
     * Tests decode(String,boolean) method trying the boolean argument, to verify if it works correctly
