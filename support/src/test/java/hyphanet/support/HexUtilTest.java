...
public class HexUtilTest {
    ...
    /**
     * Test the hexToBytes(String) method against the hex representation of every possible single byte.
    ...
    /**
     * Test biToHex(BigInteger) method comparing its results to results provided by different scientific
     * valid calculators.
     */
    @Test
    ...
    /**
     * Tests writeBigInteger(BigInteger,DataOutputStream) and readBigInteger(DataInputStream) comparing a
     * BigInteger after writing it to a Stream and reading it from the writing result.
     */
    @Test
    ...
    /**
     * Test bytesToHex(byte[],int,int) method with a too long starting offset. The tested method should
     * raise an exception.
     */
    @Test
    ...
    /**
     * Test the bitsToByte(BitSet,int) method using a size smaller than the actual number of bits in the
     * BitSet.
     */
    @Test
