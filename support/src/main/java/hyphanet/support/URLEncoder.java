 ...
 * <ul>
 *   <li>Does not convert spaces to '+' characters</li>
 *   <li>Optionally preserves non-ASCII characters</li>
 *   <li>Follows URI encoding rules rather than application/x-www-form-urlencoded format</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>{@code
...
public final class URLEncoder {
    ...
    public final static String SAFE_URL_CHARACTERS =
     ...
     * <ul>
     *   <li>Safe characters (defined in {@link #SAFE_URL_CHARACTERS}) are left unchanged</li>
     *   <li>Characters in {@code extraSafeChars} are left unchanged</li>
     *   <li>Characters in {@code force} are always encoded</li>
     *   <li>Non-ASCII characters are encoded if {@code ascii} is true</li>
     *   <li>All other characters are percent-encoded using UTF-8</li>
     * </ul>
     *
     * @param url            The string to encode
    ...
    public static String encode(
        final String url, final String force, final boolean ascii,
    ...
    private static boolean isCharacterSafe(
        final char c, final String force, final boolean ascii,
        final String extraSafeChars) {

        return (SAFE_URL_CHARACTERS.indexOf(c) >= 0 || (!ascii && isValidNonAsciiChar(c)) ||
                extraSafeChars.indexOf(c) >= 0) && (force == null || force.indexOf(c) < 0);
    }
    ...
    private static boolean isValidNonAsciiChar(final char c) {
        return c >= 128 && Character.isDefined(c) && !Character.isISOControl(c) &&
