...
public final class Encrypted implements RandomAccessBuffer, Serializable {
   ...
   */
  public Encrypted(
      EncryptType type, RandomAccessBuffer underlying, MasterSecret masterKey, boolean newBuffer)
  ...
  public static RandomAccessBuffer create(
    ...
    RandomAccessBuffer underlying =
        BucketTools.restoreRabFrom(dis, fg, persistentFileTracker, masterKey);
    try {
