...
/**
 * A RegularFile Bucket is an implementation of Bucket that writes to a file.
 *
 * @author oskar
 */
public class RegularFileBucket extends BaseFileBucket implements Serializable {
  ...
  /**
   * Creates a new RegularFile Bucket.
   *
  ...
  protected RegularFileBucket(DataInputStream dis) throws IOException, StorageFormatException {
    super(dis);
