...
/**
 * Wraps another LockableRandomAccessBufferFactory to enable encryption if currently turned
 * on.
 */
public class MaybeEncryptedRandomAccessBufferFactory
    ...
    public LockableRandomAccessBuffer makeRAF(long size) throws IOException {
        ...
        if (secret != null) {
            ...
            try {
                raf =
                    new EncryptedRandomAccessBuffer(TempBucketFactory.CRYPT_TYPE, raf, secret,
                                                    true);
