...
abstract class SwitchableProxy implements RandomAccessBuffer {

  SwitchableProxy(RandomAccessBuffer initialWrap, long size) throws IOException {
   ...
   *
   * @throws IOException If the migration failed.
   */
