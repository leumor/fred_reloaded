...
final public class HeaderStreams {
     ...
     * written to the underlying stream. * * The {@code write} methods will throw
     * {@link IOException} if bytes * different from the header are written.
     */
