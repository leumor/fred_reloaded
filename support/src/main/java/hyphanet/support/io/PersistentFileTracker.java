...
/**
 * Interface for tracking and managing persistent files in a file system. Implements functionality
 * for garbage collection, file registration, and delayed disposal of temporary files.
 *
 * <p>This tracker extends {@link DiskSpaceChecker} to ensure sufficient disk space is available for
 * operations.
 */
public interface PersistentFileTracker extends DiskSpaceChecker {
   ...
   *
   * <p>This method prevents registered files from being deleted during startup cleanup of the
   * persistent-temp directory. Only unregistered files that were present at startup will be removed
   * during cleanup.
   *
   ...
   *
   * <p>This ID is incremented with each transaction and serves as a unique identifier for tracking
   * file operations.
   *
