...
public class InetAddressIpv6FirstComparator implements Comparator<InetAddress> {
    ...
    public int compare(InetAddress arg0, InetAddress arg1) {
        ...
        // prefer LAN routable addresses over link-local addresses because most of these
		// will not work
        ...
        // prefer reachable over unreachable addresses. This is usually a ping. TODO: This
		//  actually pings all advertised ip addresses. Is that OK? Do we need a maximum
		//  number of accepted addresses to prevent abuse as DDoS?
        int a = arg0.hashCode();
        int b = arg1.hashCode();
        ...
        // among routable addresses prefer LAN addresses over global addresses, because they
		// should stay within VPNs
