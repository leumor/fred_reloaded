 ...
 * hyphanet.support.io.randomaccessbuffer.Encrypted} Random Access Buffer. This allows for seamless
...
public class Encrypted implements RandomAccessible, Serializable {
  ...
  public Encrypted(
    ...
    type = hyphanet.support.io.randomaccessbuffer.Encrypted.Type.getByBitmask(dis.readInt());
    if (type == null) {
  ...
  public RandomAccessBuffer toRandomAccessBuffer() throws IOException {
    ...
    try {
      return new hyphanet.support.io.randomaccessbuffer.Encrypted(type, r, masterKey, false);
    } catch (GeneralSecurityException e) {
      ...
      KeyParameter cipherKey =
          new KeyParameter(
              KeyGenUtil.deriveSecretKey(
                      ...
                      hyphanet.support.io.randomaccessbuffer.Encrypted.KdfInput.UNDERLYING_KEY
                          .input,
                      type.encryptKey)
                  .getEncoded());
      tempPram =
