 ...
 */
public class PaddedEphemerallyEncrypted implements Bucket, Serializable {
  ...
  private static final Logger logger = LoggerFactory.getLogger(PaddedEphemerallyEncrypted.class);
   ...
   */
  public PaddedEphemerallyEncrypted(
   ...
   */
  public PaddedEphemerallyEncrypted(PaddedEphemerallyEncrypted orig, Bucket newBucket) {
  ...
  protected PaddedEphemerallyEncrypted() {
    bucket = null;
    minPaddedSize = 0;
    key = null;
    iv = null;
  ...
  public Bucket createShadow() {
    ...
    return newUnderlying != null ? new PaddedEphemerallyEncrypted(this, newUnderlying) : null;
  }
   ...
   * is used internally by {@link PaddedEphemerallyEncrypted} to provide the encryption and padding
   * logic.
   */
  private class PaddedEphemerallyEncryptedOutputStream extends OutputStream {
    ...
    public void write(int b) throws IOException {
      synchronized (PaddedEphemerallyEncrypted.this) {
        ensureOpen();
   ...
   * in {@link PaddedEphemerallyEncrypted}. It buffers the input and output of the decryption to
   * optimize the read operations.
   */
