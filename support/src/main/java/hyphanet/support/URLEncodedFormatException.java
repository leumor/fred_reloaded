 ...
 *
 * <ul>
 *   <li>Incomplete percent-encoded sequences (e.g., "abc%2" or "test%")
 *   <li>Invalid hex digits in percent-encoded sequences (e.g., "%ZZ" or "%G2")
 *   <li>Null byte encoding attempts ("%00")
 *   <li>General malformed URL encoding patterns
 * </ul>
 *
 * <p>Example usage:
 *
