...
public class Base64Test {
     ...
     * http://en.wikipedia.org/wiki/Base_64 as reference) to verify if it decode an already
    ...
    /**
     * Test if the decode(String) method raise correctly an exception when providing a string
     * with non-Base64 characters.
     */
    @Test
    public void testIllegalBaseCharacter() {
        ...
        try {
            ...
            assertSame("Invalid Base64 character", exception.getMessage());
        }
    }

    /**
     * Test if the decode(String) method raise correctly an exception when providing a string
     * with a wrong Base64 length. (as we can consider not-padded strings too, the only wrong
     * lengths are the ones where -> number MOD 4 = 1).
     */
    @Test
    public void testIllegalBaseLength() {
        ...
        try {
            ...
            assertSame("Invalid Base64 length", exception.getMessage());
        }
    }
        ...
        for (iter = 0; iter < 1000; iter++) {
            ...
            for (int i = 0; i < b.length; i++) {
                assertEquals(b[i], decoded[i],
                             "data mismatch: index " + i + " of " + b.length +
                             " should be 0x" + Integer.toHexString(b[i] & 0xFF) + " was 0x" +
