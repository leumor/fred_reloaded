...
/**
 * Test case for {@link hyphanet.support.HexUtil} class.
 *
...
public class HexUtilTest {
    ...
    /**
     * Test the hexToBytes(String,int) method against the hex representation of every possible
     * single byte. The starting offset is always 0.
     */
    @Test
    ...
    /**
     * Test the hexToBytes(String,byte[],int) method against the hex representation of every
    ...
    /**
     * Test the bitsToByte(BitSet,int) method against the bit representation of every possible
     * single byte.
     */
    @Test
    ...
    public void testCountBytesForBits_int() {
        ...
        for (int expectedBytesCount = 1; expectedBytesCount < 256; expectedBytesCount++) {
            for (int bits = (expectedBytesCount - 1) * 8 + 1;
                 bits <= expectedBytesCount * 8; bits++) {
    ...
    /**
     * Test bytesToBits(byte[],BitSet,int) method against all possible single byte value. It
     * uses HexUtil.bitsToBytes() method for the check, so be sure that method works
     * correctly!
     */
    @Test
    ...
    /**
     * Test bitsToHexString(BitSet,int) method comparing its results to results provided by
     ...
     * comparing a BigInteger after writing it to a Stream and reading it from the writing
     * result.
     */
    @Test
    public void testWriteAndReadBigInteger() {
        ...
        try {
            ...
            assertEquals(0, methodBigInteger.compareTo(
                HexUtil.readBigInteger(methodDataInStream)));
    ...
    /**
     * Test bytesToHex(byte[],int,int) method with asking to read too many bytes. The tested
     * method should raise an exception.
     */
    @Test
    ...
    /**
     * Test hexToBytes(String,byte[],int) method with a too short byte[] to put the result. The
     * method should raise an exception.
     */
    @Test
    ...
    /**
     * Test all hexToBytes() methods with a not valid character. The method should raise an
     * exception.
     */
    @Test
    ...
    /**
     * Test the bitsToByte(BitSet,int) method using a size smaller than the actual number of
     * bits in the BitSet.
     */
    @Test
