...
public final class CommonUtil {
   ...
   *
   * <p>If the input array is {@code null}, an empty list is returned.
   *
   ...
   * @return a byte array containing the primitive byte values from the input list. Returns an empty
