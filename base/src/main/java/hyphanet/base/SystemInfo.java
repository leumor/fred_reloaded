...
/**
 * Utility class providing system-related information and detection capabilities. This class
 * handles operating system detection, architecture identification, and system charset
 * operations.
 *
 * <p>The class is marked as final to prevent inheritance as it's designed
 * to be a utility class with static members only.</p>
 */
public final class SystemInfo {
     ...
     *
     * <p>This field is initialized during class loading and remains constant
     * throughout the application lifecycle. The detection is performed using system properties
     * and filesystem characteristics.</p>
     *
