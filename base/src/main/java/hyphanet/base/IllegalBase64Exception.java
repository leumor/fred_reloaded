 ...
 *
 * <p>This exception indicates invalid Base64 data, which can occur in the following
 * cases:</p>
 * <ul>
...
public class IllegalBase64Exception extends Exception {
    ...
    /**
     * Serial version UID for serialization compatibility. A negative value is used to indicate
